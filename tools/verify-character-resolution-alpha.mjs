...
export const verifyFounderActors = () => pack({ folder: "apps/player/public/art/characters/founders-v4", revision: "founders-v4-r10-feet", identities: 30, rows: 6, poseNames: founderPoses, whiteRegression: [{ pose: "front-idle", identity: 0, minimumChannel: 220, minimumCount: 300 }, { pose: "front-idle", identity: 13, minimumChannel: 220, minimumCount: 300 }] });
