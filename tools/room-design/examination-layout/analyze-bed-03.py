...
SOURCE = Path("Photos for Codex 2/Codex Rooms 2/GS-015/examination-bed-east-03.png")
OUT = Path("tools/room-design/examination-layout/examination-bed-east-03.webp")
