...
const repo=path.resolve(import.meta.dirname,'../../..'),candidateRoot=path.join(repo,'artifacts/character-movement/gs019-blue-west/whole-body-candidate-v7'),reviewRoot=path.join(candidateRoot,'review'),manifestFile=path.join(candidateRoot,'manifest.json'),phases=['01','02','03','04','05','06','07','08'];
...
const template=readFileSync(path.join(import.meta.dirname,'gait-v7-review-template.html'),'utf8'),render=payload=>template.replace('__GS019_BLUE_V7_PAYLOAD__',JSON.stringify(payload));
