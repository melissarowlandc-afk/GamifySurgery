...
const manifestRelative = process.argv[2] || 'artifacts/character-movement/gs019-navy-walk/west-candidate-v1/manifest.json';
...
const template = readFileSync(path.join(import.meta.dirname, 'navy-review-template.html'), 'utf8');
