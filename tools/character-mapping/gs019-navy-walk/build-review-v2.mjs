...
const manifestRelative = process.argv[2] || 'artifacts/character-movement/gs019-navy-walk/west-candidate-v2/manifest.json';
...
const template = readFileSync(path.join(import.meta.dirname, 'navy-review-v2-template.html'), 'utf8');
...
const reviewFile = path.join(reviewRoot, 'navy-walk-v2-review.html'); writeFileSync(reviewFile, html);
