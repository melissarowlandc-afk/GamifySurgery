...
export interface EarningsPopupActorAnchors {
  ...
  retail_visitor?: Readonly<Record<string, boolean>>;
  companion?: Readonly<Record<string, boolean>>;
}
...
function hasVisibleActor(
  ...
  return receipt.grossAmount > 0 && anchors[receipt.actorKind]?.[receipt.actorId] === true;
}
