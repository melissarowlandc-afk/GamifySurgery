...
export const FOUNDER_HEAD_PRESETS = [
  ...
  { id: "head.04", label: "Headband Bun", group: "classic", hairStyle: "bun", hairShade: 3, faceStyle: "round", accessory: "headband", skinTone: 3, headVariant: 3 },
  { id: "head.05", label: "Bare Scalp and Glasses", group: "classic", hairStyle: "none", hairShade: 0, faceStyle: "square", accessory: "glasses", skinTone: 1, headVariant: 4 },
  { id: "head.06", label: "Tapered Crop", group: "classic", hairStyle: "short", hairShade: 1, faceStyle: "long", accessory: "badge", skinTone: 2, headVariant: 5 },
  { id: "head.07", label: "Neat Side Part", group: "classic", hairStyle: "parted", hairShade: 3, faceStyle: "round", accessory: "none", skinTone: 3, headVariant: 6 },
  { id: "head.08", label: "Curly Headband", group: "classic", hairStyle: "curly", hairShade: 2, faceStyle: "square", accessory: "headband", skinTone: 0, headVariant: 7 },
  { id: "head.09", label: "Bun and Glasses", group: "classic", hairStyle: "bun", hairShade: 1, faceStyle: "long", accessory: "glasses", skinTone: 1, headVariant: 8 },
  { id: "head.10", label: "Bare Scalp", group: "classic", hairStyle: "none", hairShade: 0, faceStyle: "round", accessory: "badge", skinTone: 2, headVariant: 9 },
  ...
  { id: "head.12", label: "Soft Bob", group: "female", hairStyle: "short", hairShade: 2, faceStyle: "square", accessory: "glasses", skinTone: 1, headVariant: 11 },
  ...
  { id: "head.15", label: "Pixie Cut", group: "female", hairStyle: "short", hairShade: 0, faceStyle: "round", accessory: "none", skinTone: 1, headVariant: 14 },
  ...
  { id: "head.17", label: "Low Ponytail", group: "female", hairStyle: "parted", hairShade: 2, faceStyle: "square", accessory: "glasses", skinTone: 3, headVariant: 16 },
  { id: "head.18", label: "Loc Bun", group: "female", hairStyle: "bun", hairShade: 3, faceStyle: "round", accessory: "none", skinTone: 0, headVariant: 17 },
  { id: "head.19", label: "Braided Crown", group: "female", hairStyle: "curly", hairShade: 0, faceStyle: "long", accessory: "headband", skinTone: 1, headVariant: 18 },
  { id: "head.20", label: "Headwrap", group: "female", hairStyle: "bun", hairShade: 2, faceStyle: "round", accessory: "headband", skinTone: 2, headVariant: 19 },
  ...
  { id: "head.27", label: "Grey Alien", group: "non-human", hairStyle: "none", hairShade: 1, faceStyle: "long", accessory: "none", skinTone: 1, headVariant: 26 },
