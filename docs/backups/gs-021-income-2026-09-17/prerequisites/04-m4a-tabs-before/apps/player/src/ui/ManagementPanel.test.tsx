...
describe("ManagementPanel", () => {
  ...
  it("wraps the complete existing employee UI in a desk-sized mode with Done", () => {
    ...
    expect(markup).toContain("Scheduled appointments");
    expect(markup).toContain("Recent receipts");
    expect(markup).toContain("Net is after stock costs, before clinic operating expenses.");
  });
});
