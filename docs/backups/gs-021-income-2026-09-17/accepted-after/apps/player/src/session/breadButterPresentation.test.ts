...
function admit(caseId: string, index: number) {
  ...
  state.rooms.push(
    { id: "room.presentation.examination", roomDefinitionId: "room.examination", x: 29, y: 23, orientation: 0, doorSide: null, upgradeLevel: 1, cleanliness: 100 },
    { id: "room.presentation.minor", roomDefinitionId: "room.minor_procedure", x: 33, y: 23, orientation: 0, doorSide: null, upgradeLevel: 1, cleanliness: 100 },
    ...([24, 25, 26, 27, 28] as const).map((y) => ({ id: `room.presentation.hall.${y}`, roomDefinitionId: "room.hallway", x: 32, y, orientation: 0 as const, doorSide: null, upgradeLevel: 1 as const, cleanliness: 100 })),
  );
  state.doors.push(
    { id: "door.presentation.examination", roomId: "room.presentation.examination", side: "east", offset: 1, exterior: false },
    { id: "door.presentation.minor", roomId: "room.presentation.minor", side: "west", offset: 1, exterior: false },
    { id: "door.presentation.front", roomId: "room.instance.founder_desk", side: "west", offset: 0, exterior: false },
  );
