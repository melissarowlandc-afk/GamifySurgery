  ...
  it("records the current clinical inventory and exact unseen-patient boundary by stage", () => {
    ...
    expect({
    ...
    }).toMatchInlineSnapshot(`
      {
        ...
        "stageOne": {
          "availableConcepts": 149,
          "cases": 380,
          "introducedConcepts": 148,
        ...
        "stageTwoExternal": {
          "availableConcepts": 164,
          "cases": 412,
          "introducedConcepts": 164,
          "patientBoundaryAcrossSeeds": {
            "maximum": 106,
            "minimum": 102,
          },
          "seededPatientsUntilNotDue": 103,
          "strandedConceptIds": [],
        },
        "stageZero": {
          "availableConcepts": 57,
          "cases": 192,
          "introducedConcepts": 56,
          "patientBoundaryAcrossSeeds": {
            "maximum": 51,
            "minimum": 47,
          },
          "seededPatientsUntilNotDue": 47,
          "strandedConceptIds": [
