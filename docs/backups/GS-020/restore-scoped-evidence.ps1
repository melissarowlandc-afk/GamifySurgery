...
$patchPath = Join-Path $packageRoot 'gs-020-baseline-to-accepted.patch'
...
Write-Output "Verified $($manifest.entryCount) scoped GS-020 evidence files in $destinationPath"
Write-Output 'This is a reconstruction of GS-020 scope, not a standalone runnable repository.'
