# Owner Row 61: Graves Clinical-Pattern Recognition — Review Draft v1

Status: `needs_clinician_review`; review artifact only, with no runtime or
publication authorization

- Review version: `review.owner-row-061.graves-pattern-recognition.2026-09-09.1`
...
remain one FSRS identity and one scored decision each.
...
All displays below are review order only; a future runtime display must shuffle
choices. The key is stated below each complete answer set for exact review.

### `presentation.graves-pattern-recognition.v1` / `question.graves-pattern-recognition.v1`

An adult presents to clinic with palpitations, heat intolerance, hand tremor,
and unintentional weight loss. Examination shows a diffusely enlarged thyroid
and bilateral proptosis. Which cause of thyrotoxicosis is most likely?
...
An adult has established thyrotoxicosis. Which examination finding most favors
Graves disease as its cause?
...
**Explanation:** Fine tremor, resting tachycardia, and muscle weakness
may accompany thyroid-hormone excess from more than one cause. Bilateral
proptosis is the finding here that most strongly supports Graves disease; it is
...
Which clinic presentation is most consistent with Graves disease in an adult
whose biochemical thyrotoxicosis is already documented?

1. An adult with a tender enlarged thyroid and localized neck pain
2. An adult with multiple discrete thyroid nodules and fine hand tremor
3. An adult with one discrete thyroid nodule and a rapid pulse
4. An adult with diffuse thyroid enlargement and bilateral proptosis

**Key:** 4 — Diffuse thyroid enlargement and bilateral proptosis.

**Explanation:** The keyed presentation combines diffuse enlargement and
...
An adult reports sweating, palpitations, and difficulty tolerating heat. The
thyroid is diffusely enlarged. There is no proptosis, but the examination shows
thickened raised plaques over the anterior shins. Which cause of thyrotoxicosis
is most likely?
...
1. Confirm or revise every complete stem, choice, key, explanation, and
   presentation above. The 2026-08-31 receipt does not approve this wording.
