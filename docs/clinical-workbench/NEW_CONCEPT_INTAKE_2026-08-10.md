...
After every workbook upload, compare the newest workbook with the last
processed version and re-rank **all** unreviewed concepts. Prefer concepts that:

1. fit the currently playable clinic or near-term Level 0–1 loop;
2. have a narrow, durable teaching point with authoritative support;
3. can produce several original variants without changing clinical meaning;
4. create a useful management decision or coherent multi-decision encounter;
5. do not depend on unbuilt hospital systems or disputed exact numbers.

Later-level and future-hospital concepts remain in the queue, but a stronger
new early-game concept may move ahead of older proposals. Priority is a review
order only; it is not clinical approval or runtime authorization.
...
| 70 | Primary repair of a selected tracheal laceration | Future ED / Trauma | Future |
| 71 | Pneumocystis prophylaxis after transplant | L0 Clinic Evaluation | Early candidate after population/timing scope |
| 72 | Obturator hernia recognition | Future ED / Trauma | Future |
| 73 | Venous air embolism response | L3 Ambulatory OR / QI | Later; acute-care sequence needs review |
| 74 | Incidental T1a gallbladder cancer after cholecystectomy | L3 Ambulatory OR / QI | Strong later-level candidate |
| 75 | Glucagon for selected absent duodenal flow during intraoperative cholangiography | L3 Ambulatory OR / QI | Later; exact dose/source boundary needed |
| 76 | Type III choledochal cyst management | L4 Pediatrics | Later |
| 77 | Gallbladder-cancer risk factors | L0 Clinic Evaluation | Early candidate |
| 78 | Common-bile-duct exploration after failed ERCP | Future Hospital OR | Future |
| 79 | Thoracentesis technique | L3 Ambulatory OR / QI | Later; procedural boundaries needed |
| 80 | Unfractionated-heparin mechanism in pulmonary embolism treatment | Future Hospital Floor | Future |
| 81 | Child-Pugh class A perioperative mortality estimate | L0 Clinic Evaluation | Deprioritize exact-number claim pending evidence |
| 82 | Surveillance after complete clinical response in rectal cancer | L0 Clinic Evaluation | Early candidate but protocol details need narrowing |
| 83 | Tunneled central access for long-term parenteral nutrition in short bowel syndrome | Future Hospital Floor | Future |
...
| 91 | Nonoperative management discussion for symptomatic cholelithiasis when surgery is declined | L0 Clinic Evaluation | Early candidate; indication boundary needed |

## First selection

Row 60, familial hypocalciuric hypercalcemia, moved to the front and completed
