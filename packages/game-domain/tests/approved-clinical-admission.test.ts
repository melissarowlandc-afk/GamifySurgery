...
import { BOARD_EXPANSION_20260912_TESTED_CONCEPTS, BOARD_EXPANSION_TESTED_CONCEPTS, BREAD_BUTTER_20260917_TESTED_CONCEPTS, BRIEF_EARLY_LEVELS_20260917_TESTED_CONCEPTS, EARLY_LEVELS_20260913_TESTED_CONCEPTS, LEVEL_TWO_RUNTIME_CONCEPTS, SURGERY_CENTER_TESTED_CONCEPTS, TWENTY_CONCEPT_BATCH_CONCEPTS } from "@gamify-surgery/clinical-content";
import {
...
describe("approved clinical admission boundaries", () => {
  ...
  it("keeps the active runtime release limited to reviewed concepts", () => {
    expect(
      ...
      ...BRIEF_EARLY_LEVELS_20260917_TESTED_CONCEPTS.map((concept) => concept.id),
      ...BREAD_BUTTER_20260917_TESTED_CONCEPTS.map((concept) => concept.id),
    ]);
  });
