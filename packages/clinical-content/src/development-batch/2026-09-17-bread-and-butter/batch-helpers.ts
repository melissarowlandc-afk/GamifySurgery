...
export const BATCH_CONTENT_VERSION =
  "development-batch.2026-09-17.bread-and-butter.1";
...
export interface DevelopmentServiceContract {
  ...
  delivery:
    | "existing_balance_contract"
    | "new_external_contract_required"
    | "new_in_house_contract_required";
}
...
export function claim(
  ...
  return {
    ...
    ...args,
    evidenceCategory:
      args.evidenceCategory === "diagnosis" ? "evaluation" : args.evidenceCategory,
  };
}
